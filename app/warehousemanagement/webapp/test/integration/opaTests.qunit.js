...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "warehousemanagement/test/integration/FirstJourney",
    "warehousemanagement/test/integration/WarehousesListJourney",
    "warehousemanagement/test/integration/WarehousesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
