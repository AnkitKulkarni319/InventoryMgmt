...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "movementconsole/test/integration/FirstJourney",
    "movementconsole/test/integration/StockMovementsListJourney",
    "movementconsole/test/integration/StockMovementsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
